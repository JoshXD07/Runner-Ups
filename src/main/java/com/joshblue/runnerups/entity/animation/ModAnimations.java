...
public class ModAnimations {
    ...
    public static final Animation GREAT_HUNGER_WALK = Animation.Builder.create(1f).looping()
    ...
    public static final Animation GREAT_HUNGER_ATTACK = Animation.Builder.create(0.5f)
